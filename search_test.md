...
木 キャンディインディアン寄宿学国立博物館顔認識北部看護学校システム身障者補助犬法ざわざわ森のがんこちゃん新報社乱暴者新参者
段落内にも何回も白石阿島登場します新城心所杜子春栄枯盛衰
晋代 勧め世界保健機関三寒四温 三寒四温脳科学理学部数学科


github リポジトリを更新したので確認してください。
nvim-skk を起動すると、skkserverに接続していないと アラートが出ますが、実際には ライブ補完や、 <SPC> での変換も可能なので、yaskkserv2 に接続していると思われます。
